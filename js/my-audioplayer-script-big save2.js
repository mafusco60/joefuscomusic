...
const musicTitles = document.querySelector('#choices');
...
{	
	...
	//const sec = Math.trunc (duration % onemin);
	//var playlistTimeString 
	//var str1 = min.toString();
	//var str2 = ":"
	//var str3 = sec.toString();
	//playlistTimeString = str1.concat(str2,str3);
	//const playlistTimes = 
	//getPlaylistTimes(songs[i]);
	
	playlistBtns[i].innerHTML = `<h4>${songs[i]} ... ${songDurations[i]}</h4>`;		
