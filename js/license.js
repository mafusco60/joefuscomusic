...
//Global colors
const normalSongTitleColor = 'darkBlue';
const activeSongTitleColor = 'black';
...
//enboldens playing song title - =>checked
...
//CONSIDER A CATEGORY ARRAY CALLING THIS FUNCTION
...
//categories of songs to go into seperate columns - Change this...............
...
//fill columns with titles .....................  FOREACH USING A CATEGORY ARRRAY ---ELIMINATE THIS ANYWAY TO CALL WHEN CLICKED
...
function createLbls (songsArray){
	...
	while (i < songsArray.length){
		...
		// CHECK CATEGORY OF SONG AND PUT IT IN A ARRAY
		//LIST CATEGORIES AND MAKE BUTTONS
		//FILL CATEGORY BUTTON WITH FILTERED TITLES BASED ON AN ADDLISTENER EVENT
		//GET RID OF COLUMNCOUNTER - USE CATEGORYARRAY
