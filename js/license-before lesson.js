...
//Song class playlist info array
const songlist = [
...
//create an array for a category of songs
...
//determine how many columns are needed to display song titles
let columnCounter = 0;
...
//const acousticXMASArray = createSortArray ('Acoustic Album - Let\'s Trim The Tree'); keep this line
...
function createLbls (songsArray){
	...
	while (i < songsArray.length){
		...
		playlist[i].innerHTML = (`${songsArray[i].title} <br>${songsArray[i].duration}`);
